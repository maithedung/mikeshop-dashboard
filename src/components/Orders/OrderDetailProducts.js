...
const OrderDetailProducts = (props) => {
    ...
    return (<table className="table border table-lg">
        <thead>
        <tr>
        ...
        <tbody>
        {order.orderItems.map((item, index) => (<tr key={index}>
            <td>
            ...
            <td colSpan="4">
                <article className="float-end">
                    ...
                    <dl className="dlist">
                        ...
                        <dd>
                            {order.isPaid ? (<span className="badge btn-success alert-success text-success">
                                Payment done
                            </span>) : (<span className="badge btn-danger alert-danger text-danger">
                                Not Paid
                            </span>)}
                        </dd>
                    </dl>
